...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="{{ url('/dashboardpt') }}"><img src="./assets/compiled/svg/logo.svg" alt="Logo"></a>
            </div>
 ...
 <form onsubmit="return validateForm()">
    <div class="form-group position-relative has-icon-left mb-4">
        ...
        <small id="emailError" class="text-danger" style="display: none;">Email harus diisi!</small>
    </div>
    <div class="form-group position-relative has-icon-left mb-4">
        ...
        <small id="usernameError" class="text-danger" style="display: none;">Username harus diisi!</small>
    </div>
    <div class="form-group position-relative has-icon-left mb-4">
        ...
        <small id="passwordError" class="text-danger" style="display: none;">Password harus diisi!</small>
    </div>
    <div class="form-group position-relative has-icon-left mb-4">
        ...
        <small id="confirmPasswordError" class="text-danger" style="display: none;">Konfirmasi password harus diisi!</small>
    </div>
