                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="addForm">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <label>NIP</label>
                                                        <input type="text" id="nipPembimbing" class="form-control"
                                                            required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>Jurusan</label>
                                                        <select id="jurusanPembimbing" class="form-control" required>
                                                            ...
                                                            <option value="MPLB">Otomatisasi dan Tata Kelola
                                                                Perkantoran</option>
                                                            <option value="AKL">Akuntansi dan Keuangan Lembaga
                                                            </option>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" id="kelasPembimbing"
                                                            class="form-control" placeholder="Contoh: XII RPL 1"
                                                            required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>No HP</label>
                                                        <input type="text" id="nohpPembimbing"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>Email</label>
                                                        <input type="email" id="emailPembimbing"
                                                            class="form-control" required>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="editForm">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <label>Nama Pembimbing</label>
                                                        <input type="text" id="namaPembimbing_edit"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>NIP</label>
                                                        <input type="text" id="nipPembimbing_edit"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>Jurusan</label>
                                                        <select id="jurusanPembimbing_edit" class="form-control"
                                                            required>
                                                            <option value="">Pilih Jurusan</option>
                                                            <option value="RPL">Rekayasa Perangkat Lunak</option>
                                                            <option value="TKJ">Teknik Komputer dan Jaringan
                                                            ...
                                                            <option value="OTKP">Otomatisasi dan Tata Kelola
                                                                Perkantoran</option>
                                                            <option value="AKL">Akuntansi dan Keuangan Lembaga
                                                            </option>
                                                            <option value="BDP">Bisnis Daring dan Pemasaran</option>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <label>Kelas Bimbingan</label>
                                                        <input type="text" id="kelasPembimbing_edit"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>No HP</label>
                                                        <input type="text" id="nohpPembimbing_edit"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <label>Email</label>
                                                        <input type="email" id="emailPembimbing_edit"
                                                            class="form-control" required>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    $('#updateButton').click(function(e) {
                                                ...
                                                if (!data.nama || !data.nip || !data.jurusan || !data.kelas || !data.no_hp || !data.email) {
                                                    ...
                                                    $('#saveButton').click(function(e) {
                                                        ...
                                                        // Validasi form
                                                        if (!data.nama || !data.nip || !data.jurusan || !data.kelas || !data.no_hp || !data
                                                            .email) {
                                                            alert('Semua field harus diisi!');
                                                            return;
                                                        }
