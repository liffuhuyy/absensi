                        ...
                        <form method="POST" action="{{ url('/absen/masuk') }}">
                            <div class="container">
                                ...
                                <div class="card">
                                    ...
                                    <a href="{{ url('/dashboard') }}" class="btn btn-primary">Kembali ke
                                        Dashboard</a>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div id="absenContainer" class="container p-3">
                                                        ...
                                                        <div class="button-group">
                                                            <form method="POST" action="{{ url('/absen/masuk') }}">
                                                                @csrf
                                                                <button id="btnMasuk" class="btn-masuk">Absen
                                                                    Masuk</button>
                                                            </form>
                                                            <form method="POST" action="{{ url('/absen/keluar') }}">
                                                                @csrf
                                                            ...
                                                            <form method="POST" action="{{ url('/izin') }}">
                                                                @csrf
                                                                <button id="btnIzin" class="btn-izin">Izin /
                                                                    Sakit</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="jenis_izin" id="jenis_izin"
                                                                    ...
                                                                    <div id="absenContainer" class="container p-2">
                                                                        <h2 class="card-title text-center">Riwayat
                                                                            Absensi</h2>
                                                                        <label class="text-muted mb-3">Pilih bulan dan
                                                                            tahun untuk melihat riwayat absensi.</label>
                                                                        ...
                                                                        <div class="stats-card d-flex justify-content-around mb-3"
                                                                            ...
                                                                            @foreach ($stat as $key => $icon)
                                                                                <div class="stat-item text-center">
                                                                                    <h3>{{ ucfirst($key) }}</h3>
                                                                                    <span
                                                                                        class="stat-icon">{{ $icon }}</span>
                                                                                    <span class="stat-value"
                                                                                        id="stat-{{ $key }}">{{ $statistik[$key] ?? 0 }}</span>
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
                                                                                    ...
                                                                                    <tbody id="absensiTbody">
                                                                                        @forelse ($absensiData as $absen)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>{{ $absen->absen_masuk ?? '-' }}
                                                                                                </td>
                                                                                                <td>{{ $absen->absen_pulang ?? '-' }}
                                                                                                </td>
                                                                                                <td>{{ $absen->pulang_awal ? 'Ya' : '-' }}
                                                                                                </td>
                                                                                                <td>{{ $absen->keterangan ?? '-' }}
                                                                                                </td>
                                                                                            </tr>
