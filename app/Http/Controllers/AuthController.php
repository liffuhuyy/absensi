...
class AuthController extends Controller
{
    ...
    // ✅ Tambahan untuk menghindari error: Method beranda() not found
    public function beranda()
    {
        return view('absensi.beranda'); // pastikan file ini ada di resources/views/absensi/beranda.blade.php
    }
}
